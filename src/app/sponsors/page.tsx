  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-primary selection:text-black">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8">
          {sponsors.map((s, i) => (
            <motion.div
              ...
              className="p-8 rounded-[2rem] bg-neutral-900/60 border border-white/10 hover:border-primary/40 backdrop-blur-xl space-y-6 transition-all duration-300 hover:-translate-y-2 group"
            >
        ...
        <div className="mt-20 p-12 rounded-[2.5rem] bg-gradient-to-b from-white/10 to-transparent border border-white/10 backdrop-blur-xl text-center space-y-6 max-w-4xl mx-auto">
          <Zap className="w-12 h-12 text-primary mx-auto" />
          <h2 className="text-3xl font-black uppercase">Partner With A1 Esports</h2>
